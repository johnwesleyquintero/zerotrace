...
title ZeroTrace v1.2

:: =====================================================
:: ZeroTrace v1.2
:: A sovereign Windows cleanup utility — leaves zero trace.
:: https://github.com/johnwesleyquintero/zerotrace
:: v1.2 adds: Optional hibernation disable + shadow copy deletion
:: Download .exe and .bat file here: https://zerotrace-ai.vercel.app
:: =====================================================
...
echo !CYAN!!BOLD!  ZeroTrace v1.2 - Leaving Zero Trace!RESET!
...
:: ==================================================
echo.
echo !CYAN![1/18] Cleaning temporary files...!RESET!
...
call :ProgressBar 1 18

:: ==================================================
:: [2/18] Browser Caches
:: ==================================================
echo.
echo !CYAN![2/18] Clearing browser caches...!RESET!
...
call :ProgressBar 2 18

:: ==================================================
:: [3/18] Windows Update Cleanup
:: ==================================================
echo.
echo !CYAN![3/18] Cleaning Windows Update files...!RESET!
...
call :ProgressBar 3 18

:: ==================================================
:: [4/18] Windows.old & Upgrade Debris
:: ==================================================
echo.
echo !CYAN![4/18] Removing Windows.old and upgrade debris...!RESET!
...
call :ProgressBar 4 18

:: ==================================================
:: [5/18] Event Logs
:: ==================================================
echo.
echo !CYAN![5/18] Clearing Event Logs...!RESET!
for /f "tokens=*" %%i in ('wevtutil el') do wevtutil cl "%%i" >nul 2>&1
echo !GRAY![OK] Event logs cleared.!RESET!
call :ProgressBar 5 18

:: ==================================================
:: [6/18] Windows Logs
:: ==================================================
echo.
echo !CYAN![6/18] Cleaning Windows logs...!RESET!
...
call :ProgressBar 6 18

:: ==================================================
:: [7/18] Prefetch
:: ==================================================
echo.
echo !CYAN![7/18] Clearing Prefetch...!RESET!
...
call :ProgressBar 7 18

:: ==================================================
:: [8/18] Recycle Bin
:: ==================================================
echo.
echo !CYAN![8/18] Emptying Recycle Bin...!RESET!
PowerShell.exe -Command "Clear-RecycleBin -Force -ErrorAction SilentlyContinue" >nul 2>&1
echo !GRAY![OK] Recycle Bin emptied.!RESET!
call :ProgressBar 8 18

:: ==================================================
:: [9/18] Store Cache + Network
:: ==================================================
echo.
echo !CYAN![9/18] Resetting Store cache and network...!RESET!
wsreset.exe >nul 2>&1
ipconfig /flushdns >nul 2>&1
netsh winsock reset >nul 2>&1
netsh winhttp reset proxy >nul 2>&1
echo !GRAY![OK] Store and network reset complete.!RESET!
call :ProgressBar 9 18

:: ==================================================
:: [10/18] Privacy: Recent Files & Jump Lists
:: ==================================================
echo.
echo !CYAN![10/18] Clearing Recent Files and Jump Lists...!RESET!
...
call :ProgressBar 10 18

:: ==================================================
:: [11/18] System Maintenance: Cache & Error Reports
:: ==================================================
echo.
echo !CYAN![11/18] Cleaning system caches and error reports...!RESET!
:: Thumbnail Cache
...
call :ProgressBar 11 18

:: ==================================================
:: [12/18] VS Code & Discord Caches
:: ==================================================
echo.
echo !CYAN![12/18] Cleaning VS Code and Discord caches...!RESET!
...
call :ProgressBar 12 18

:: ==================================================
:: [13/18] Spotify Media Cache
:: ==================================================
echo.
echo !CYAN![13/18] Clearing Spotify media cache...!RESET!
...
call :ProgressBar 13 18

:: ==================================================
:: [14/18] GPU Shader Caches (NVIDIA/AMD)
:: ==================================================
echo.
echo !CYAN![14/18] Cleaning GPU shader caches...!RESET!
:: NVIDIA
...
call :ProgressBar 14 18

:: ==================================================
:: [15/18] Advanced Space Reclamation
:: ==================================================
echo.
echo !CYAN![15/18] Reclaiming advanced disk space...!RESET!
...
call :ProgressBar 15 18

:: ==================================================
:: [16/18] Deep Trace Removal (Registry & Shell)
:: ==================================================
echo.
echo !CYAN![16/18] Performing deep trace removal...!RESET!
...
call :ProgressBar 16 18

:: ==================================================
:: [17/18] Optional: Disable Hibernation 
:: ==================================================
echo.
echo !YELLOW![17/18] Optional: Disable Hibernation!RESET!
echo !GRAY!This deletes hiberfil.sys and frees ~75% of your RAM size.!RESET!
echo !GRAY!You will lose the ability to Hibernate. Sleep still works.!RESET!
set /p HIBER="Disable hibernation and delete hiberfil.sys? [y/N]: "
if /i "!HIBER!"=="y" (
    echo !CYAN!Disabling Hibernation...!RESET!
    powercfg -h off >nul 2>&1
    echo !GREEN![OK] Hibernation disabled. hiberfil.sys removed.!RESET!
) else (
    echo !GRAY![SKIPPED] Hibernation left enabled.!RESET!
)
call :ProgressBar 17 18

:: ==================================================
:: [18/18] Optional: Delete All Restore Points
:: ==================================================
echo.
echo !RED![18/18] Optional: Delete All System Restore Points!RESET!
echo !GRAY!This deletes ALL shadow copies. You cannot roll back Windows after.!RESET!
set /p SHADOW="Delete ALL System Restore points? [y/N]: "
if /i "!SHADOW!"=="y" (
    echo !CYAN!Deleting Shadow Copies...!RESET!
    vssadmin delete shadows /all /quiet >nul 2>&1
    echo !GREEN![OK] All restore points deleted.!RESET!
) else (
    echo !GRAY![SKIPPED] Restore points preserved.!RESET!
)
call :ProgressBar 18 18
...
echo.
echo !CYAN!!BOLD!==================================================!RESET!
echo !GREEN!!BOLD!  ZERO TRACE v1.2 COMPLETE.!RESET!
echo !CYAN!!BOLD!==================================================!RESET!
